...
namespace IMIC.OfflineDB
{
    ...
    public partial class eTrainingOfflineEntities : DbContext
    {
        //public eTrainingOfflineEntities()
        //    : base("name=eTrainingOfflineEntities")
        //{
        //}
        public eTrainingOfflineEntities(string obj)
            : base(obj)
        {
        }
